...
class UserTest extends TestCase
{
    ...
    {
        //Arrange creation de l'objet de type user :: est une methode statique
    ...
    //fournisseur de données pour les methodes de test
    public function getValidationTestCases()
    {
        return //retour un tableau associative de 5 elements
        [
